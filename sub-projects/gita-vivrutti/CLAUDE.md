...
**Chapter XI (Viśvarūpa-darśana Yoga) — started. 11.1–11.45 done and proofread.**
...
|-------|-------|
| Next śhloka | **11.46** |
| Chapter XI status | `CHAPTERS[11]` exists (nameDev, nameEn, desc, `footnotes` array, verses). Verses 1–45 populated. Speaker was `अर्जुन उवाच` through 11.31, changed to `श्रीभगवानुवाच` at 11.32, changed to `सञ्जय उवाच` at 11.35, changed to `अर्जुन उवाच` at 11.36 and confirmed unchanged through 11.45 (Arjuna's हृषीकेशस्तवः/hymn of praise). Confirmed this session (direct PDF read of page 414): Arjuna continues through 11.46 as well; Kṛṣṇa does not resume speaking until 11.47 (`श्रीभगवानुवाच`, visible right after 11.46 on the same page) — so 11.46 needs no speaker-change line either, but 11.47 will. |
| PDF page for 11.46 | Already rendered and read this session (informational only — not yet drafted): PDF page 414 bottom, Sanskrit page ३६८ (page-offset formula: Sanskrit page + 46). मूल, राॕ commentary, and one footnote for 11.46 are already visible from this session's page-414 render; still re-verify at draft time. |
| OCR anchor | 11.46 opens "किरीटिनं गदिनं चक्रहस्तमिच्छामि त्वां द्रष्टुमहं तथैव" — grep "किरीटिनं गदिनं" to confirm/locate in the OCR. |
| Outstanding | **Two open flags carried from 11.15, still not resolved by curator — don't block resuming:** (1) footnote "१. पाद्मवचनम् — गी.ता." placement uncertainty at PDF page 399. (2) Judgment call on bolding `अर्जुन उवाच` as a speaker-heading citation at 11.15. **Flags from 11.16–11.24 (open, non-blocking):** (3) 11.16's two-footnote-on-one-verse structure. (4) Bolding bare exact-form particles/pronouns (न, मे, हि, तथा, अहम्) — a recurring pattern since 11.16, not resolved as a blanket policy either way. (5) 11.20's sentence 4 is the densest single bolded sentence yet (4 bold spans). (6) 11.20's "उग्रमिव"/"तूग्रमेव" left unbolded — sandhi merges the मूल word into a following particle with no clean akṣara boundary for a bold span, a new edge case. (7) 11.20's "लोकत्रयपदेन"/"लोकत्रयस्थ" left unbolded under the current strict rule, though 11.9's `महायोगेश्वरत्वं` was bolded in an analogous-looking situation before the rule was sharpened — flagged rather than resolved unilaterally. (8) 11.27's three open judgment calls (ते double-gloss reading, dropped-उपसर्ग non-bolding of दृश्यन्ते, footnote superscript position) — curator approved the draft as presented without further resolving these; revisit if they recur or a cleaner precedent emerges. (9) 11.31's footnote "१" (ऐतरेय ११/२/३ citation, on मूल word "को") was judged 〔वि॑-only and skipped — it sits on the मूल line itself rather than inside either commentary block, unlike prior skipped footnotes which sat inside an explicit (वि) block; curator flagged for a possible spot-check, not yet revisited. (10) 11.32's footnote "२" transcription (the Mahābhārata Sauptika-parva verse naming the war's ten survivors) is a best-effort reading of a dense block of proper names from the rendered PDF page — curator asked to spot-check it against the print when convenient; not yet confirmed. **(11) 11.32's footnote "१"** (added retroactively this session, the Kāla/Janārdana-epithet citation set) — best-effort transcription and translation of three bundled sub-citations (Bhāratatātparya, Bhāratatātparya 11.3.8, Mahāvārāha per Gītā Tātparya); curator spot-check requested, same as (10). **(12) 11.33's footnotes १ and २ (page 408 list)** are bare citation pointers ("गी. २-६," "गी. २-३७") with almost no content of their own — included as footnotes for consistency with the project's always-footnote convention, but flagged as a judgment call: these could arguably be inlined into the translation instead of given full footnote treatment, since they're just chapter-verse references, not independent explanatory citations like every other footnote so far. Revisit if a cleaner pattern is wanted. **(13) 11.33 is the first verse where the same digit ("२") appears twice** in one verse's footnote set (page 407's २ and page 408's २ are unrelated citations) — handled per the standing "trace by position, not digit" rule, but flagged as a new, more visually confusable case than the previous cross-verse resets. **(14) 11.39's footnote "१"** ("नियमो यमः," विष्णुसहस्रनाम) — **RESOLVED, curator-confirmed correct (2026-09-20):** attached to राॕ's commentary word "यमः" in "<b>यमः</b> दोषोपरतिमान्," exactly as tentatively drafted. No longer an open flag. **(15) 11.40's footnote "सर्वः शर्वः शिवः स्थाणुः"** (page 412's own footnote "२") — **RESOLVED, curator-corrected (2026-09-20):** the mark Claude read as a stray opening quotation mark before "सर्वोऽसि" (in राॕ's sentence "यतः ततः सर्वोऽसि") was in fact this footnote's own superscript "२," not punctuation — Claude's zoom-based judgment was wrong, and the footnote had been left out of the HTML entirely on the mistaken assumption it was वि-only. Fixed: the apostrophe is removed, the genuine `<sup>२</sup>` is now attached right after "सर्वोऽसि," and the footnote text is included as the last entry of 11.40 (now carrying the ॥४०॥ marker). Separately, page 412's footnote "१" (छां ३-१४-१) also needed its own in-text marker added — it had been appended as a footnote entry but the corresponding `<sup>१</sup>` was missing from its actual citation point (राॕ's own quote "सर्वं खल्विदं ब्रह्म" in commentary sentence 4); this is now fixed too. 11.40 keeps all four footnotes (page 411's २/३ on the मूल line, page 412's १/२ in the commentary), citation-ordered dev-before-skt as usual. **Standing lesson: when a zoomed image is ambiguous between a footnote digit and a punctuation mark, and the curator has the physical book or clearer photos on hand, ask for a spot-check rather than defaulting to exclusion — excluding a real footnote is exactly as much an error as fabricating one.** **(16) 11.39's मूल OCR error** — "अशिः" should read "अग्निः" (अशिः is not a real word; अग्निर्वरुणः confirmed clearly in the PDF render) — corrected before writing, noted here only as a reminder that this book's OCR keeps producing this kind of single-akṣara corruption. **(17) Confirmed at 11.44: not every verse necessarily carries a 〔वि॑ commentary in the print** — 11.44 has 〔रा॑ only, verified directly against the PDF (not an extraction gap). Worth remembering when auditing for missing content — absence of 〔वि॑ on a given verse is normal, not a sign something was dropped. **(18) RESOLVED — process lapse, 11.41–11.45 drafting (2026-09-20):** a first draft briefly included 〔वि॑ (Vidyādhirāja Tīrtha's) commentary in violation of this file's own always-रा-only rule (see "Session Workflow" step 1 and "Key source note"); caught by the curator before any write, corrected to रा-only. See History (23)–(24) for the full account, including three further curator corrections (11.41 footnote ३'s कचित्→क्वचित्; 11.43's गुणान्तरोत्त्या→गुणान्तरोक्त्या and the गरीयान्/गुरुः dual-bolding call; 11.44's यस्मादुत्तमहामहिमा→यस्मादुक्तमहामहिमा). No longer open — flagged here only so a future session doesn't need to dig through the History log to find why this rule is emphasized. Ch. XI 1–45 fully written and proofread. |
...
**Key source note:** The OCR file contains both Vidyādhirāja Tīrtha's (〔वि〕) and Rāghavendra Tīrtha's (〔रा〕) commentaries — two distinct commentators whose texts are printed interleaved on the same pages (never confuse 〔वि〕 with Madhvācārya's separate Gītā Bhāṣya, which is not in this source at all). **This project transcribes ONLY 〔रा〕 into the HTML — Śrī Rāghavendra Tīrtha's गीता विवृत्तिः is the entire point of this deliverable.** The 〔वि〕 sections are ignored entirely, in every field, always — including when rendering a PDF page for verification purposes shows both (वि) and (रा) labeled blocks together: reading 〔वि〕 text during verification is normal and expected, but no 〔वि〕 material — no lines, no sentences, no footnotes — may appear in a draft or in the HTML, ever. **This rule was briefly violated at the 11.41–11.45 drafting stage (2026-09-20) despite already being stated here — see History item (23) — so treat this note as more than boilerplate: actively re-check every draft against it before presenting.**
...
and proofread; Chapter XI is underway (11.1–11.45 done). Continue at śhloka 11.46,
following the PDF-first workflow: extract the mūla + 〔रा॑ commentary + footnotes from
...
HTML on my go-ahead. IMPORTANT — reconfirmed 2026-09-20 after a real lapse: transcribe
〔रा॑ (Rāghavendra Tīrtha's गीता विवृत्तिः) ONLY — never 〔वि॑ (Vidyādhirāja Tīrtha's
separate commentary, printed interleaved in the same source). Seeing both labeled
blocks while rendering a PDF page for verification is normal; including any 〔वि॑
material in the draft or HTML is not — see "Key source note" and History (23)-(24).
Note: at 11.32 a (वि) block was found to silently continue across a page break with no
OCR cue — always confirm which side of a page break a (वि)/(रा) heading's scope
actually ends, don't assume a block ends at the page image's edge. Also: a footnote
superscript can look like a stray quotation mark in this print — this has happened at
11.32, 11.39/11.40, and note 11.44 has NO 〔वि॑ commentary at all (confirmed genuine,
not a gap) — always zoom in close on every raised mark near a citation and compare its
shape against a confirmed digit nearby before deciding; don't assume it's punctuation,
but don't force a footnote onto a mark that turns out to be a quote either. 11.46
continues अर्जुन उवाच (no speaker change expected — confirmed via direct PDF read this
session that Kṛṣṇa doesn't resume speaking until 11.47) — mūla opens "किरीटिनं गदिनं
चक्रहस्तमिच्छामि त्वां द्रष्टुमहं तथैव...". PDF page 414 (bottom) already rendered and
read this session for 11.46 — re-verify at draft time rather than re-rendering blind.
```

Claude should then:
1. Read this file for full context (workflow, strict rules, HTML architecture, Resume Pointer), especially the refined pratīka-bolding rule (exact word-form match, not just root reuse), the always-रा-only scope rule (see "Key source note" — briefly violated once, see History (23)), and the open flags noted in the Resume Pointer table (including the footnote-attribution and footnote-transcription flags from 11.31–11.45).
2. Read `gita_vivrutti.html` to see the exact current DEFS dictionary and verse-data structure, and the existing `CHAPTERS[11]` object (verses 1–45 populated so far).
3. Locate 11.46 in the OCR (it follows immediately after 11.45's रा commentary), render and verify against the PDF (page-offset formula: Sanskrit page + 46; page 414 already rendered this session) — draft रा-only, and proceed on approval. Watch for (वि) blocks continuing silently across a page break, as happened at 11.32, and for footnote superscripts that look like stray quotation marks, as happened at 11.32, 11.39, and 11.40. Remember 11.47 begins `श्रीभगवानुवाच` — a speaker change to watch for right after 11.46.
...
*Last updated: Session through śhloka 11.45 (2026-09-20) — Chapter XI (Viśvarūpa-darśana Yoga) continuing; 11.1–11.45 written + proofread. Process refinements, now standing rules (see "Session Workflow" and "Footnotes and Image Citations" sections above):*
...
*(21) 11.35–11.40 batch (2026-09-20): drafted, presented in full for curator review, and approved ("ok") before any write — the draft-then-approve gate (see the top-of-file rule and history item (20)) held correctly this time. Speaker changed twice: `सञ्जय उवाच` at 11.35 (Sañjaya resumes narrating), then `अर्जुन उवाच` at 11.36, continuing through 11.40 as Arjuna's hymn of praise to the viśvarūpa. Caught one OCR error (11.39 "अशिः"→"अग्निः," see Resume Pointer (16)). This batch surfaced the quotation-mark/footnote-superscript confusion (first documented at 11.32, item (19)) TWICE more, in a harder form: at 11.39, close zooming could not upgrade राॕ's "यमः" mark to a confirmed digit, so footnote "१" was attached on content grounds only and flagged (Resume Pointer (14)); at 11.40, page 412's own footnote "२" could not be matched to any mark in राॕ's text at all despite the same close zooming, and was left out of the HTML entirely, flagged rather than guessed (Resume Pointer (15)). Also confirmed a new footnote-density record isn't a problem to solve — 11.40 alone carries footnotes from two different pages' independent numbering, handled correctly by the existing "citation order: dev line before skt lines, in order of appearance" convention (see item (11) and the 11.16/11.32 precedents).*

*(22) CURATOR CORRECTIONS to the 11.35–11.40 batch, same day (2026-09-20): after reviewing the written HTML against the physical book, the curator sent three corrections. (a) 11.36's footnote text had a transcription error — "वध्र्यस्त्विन्द्रियाण्याहुर्हृषीकाणीति" should read "वध्रयस्त्विन्द्रियाण्याहुर्हृषीकाणीति" (fixed). (b) 11.39's footnote "१" placement — confirmed correct as drafted (see Resume Pointer (14), now resolved). (c) 11.40's footnote "सर्वः शर्वः शिवः स्थाणुः" — the curator confirmed this footnote (page 412's own "२") is genuinely present and belongs on राॕ's word "सर्वोऽसि"; what Claude had read as a stray opening quote mark there was in fact this footnote's own superscript digit, misjudged as punctuation in the earlier zoom-based check. The footnote — wrongly excluded in the original draft — has now been added, the false apostrophe removed, and the missing in-text marker for page 412's footnote "१" (on राॕ's own citation "सर्वं खल्विदं ब्रह्म") added as well. See Resume Pointer (15) for the full account. **Standing lesson, reinforcing (19) and (21): visual zoom-based judgment calls about footnote-vs-punctuation marks are inherently fallible in this print — when Claude cannot resolve one with full confidence, say so plainly (as was done here) so the curator can check against the physical book, and treat any such correction as informative, not just a one-off fix — the same ambiguity will recur.***

*(23) PROCESS LAPSE — 〔वि॑ commentary drafted by mistake, 11.41–11.45 batch (2026-09-20): despite the standing rule already documented in this very file (Session Workflow step 1, and "Key source note": "Only 〔रा॑ goes into the HTML. The 〔वि॑ sections are ignored entirely"), the first draft of 11.41–11.45 included full 〔वि॑ (Vidyādhirāja Tīrtha's) commentary lines alongside 〔रा॑ — apparently because both bracket labels were visible together on the rendered PDF pages during verification and got carried into the draft without re-checking against this file's own scope rule. Caught by the curator before anything was written to HTML: "I see that somehow the 'वि' commentary is now added for these shlOkas. We dont need them in this project. We are only focusing on rAghavEndrA's gItA vivrttiH commentary." The curator also clarified that 〔वि॑ stands for **Vidyādhirāja Tīrtha's** own commentary — a distinct earlier commentator whose text is printed interleaved with राघवेन्द्र's in the same source — **not Madhvācārya's** Gītā Bhāṣya; this file's own terminology was already correct on this point (it never said "Madhva"), so the confusion existed only in the assistant's own within-session reasoning/summary, not in any written project document. No HTML content was affected by the lapse — verses 1–40 were checked and confirmed to contain zero 〔वि॑ occurrences before this batch was written, and the redrafted, curator-approved 41–45 batch (see (24)) is रा-only throughout, as committed. **Standing rule reinforced and made more explicit in "Key source note" above: even while rendering PDF pages that visibly show both (वि) and (रा) labeled blocks for verification purposes — which is normal and necessary, since both appear on the same printed page — only material under a (रा) heading may enter a draft or the HTML. Seeing 〔वि॑ text during verification is expected; using any of it in the deliverable is not, ever.***

*(24) CURATOR CORRECTIONS to the redrafted (रा-only) 11.41–11.45 batch, same session (2026-09-20): (a) **11.41 footnote ३** — transcription had "कचित्" (not a standard Sanskrit word) where the print reads "क्वचित्" ("in some cases," a common indefinite adverb), occurring three times in the citation ("क्वचित् तद्भावशेषः स्यात्...क्वचिद्भवेत्...क्वचित्पदार्थशेषः..."); corrected, and the translation reworked around the natural क्वचित्...क्वचित्...क्वचित् threefold enumeration this produces. (b) **11.43 commentary sentence 1** — "गुणान्तरोत्त्या" (not a standard compound) corrected to "गुणान्तरोक्त्या" ("by the statement of a further quality"). (c) **11.43's "गरीयान् गुरुः"** — curator directed that both words be bolded together, since राघवेन्द्र is showing अन्वयः (the grammatical construal linking the two मूल words गरीयान् and गुरुः, both of which occur in मूल's "गुरुर्गरीयान्"), not glossing one with the other as a synonym; the immediately-prior draft had left गुरुः unbolded on the (incorrect) assumption it was राॕ's own explanatory synonym for गरीयान्. (d) **11.44 commentary sentence 1** — "यस्मादुत्तमहामहिमा" (misread as "of supreme great glory," उत्तम) corrected to "यस्मादुक्तमहामहिमा" ("because [Your] great glory has already been stated," उक्त — referring back to the viśvarūपa vision just shown) — a single-akṣara OCR/reading confusion (उत्त vs उक्त), the same general category as the व/ब and (ग)/(रा) confusions documented earlier in this file (see (13), (16)). All four corrections were applied before writing; the corrected, रा-only batch was then approved ("Draft is approved. Go ahead and commit") and written. Also noted by the curator: "मूल" as a bare word is grammatically incomplete Sanskrit — "मूलम्" (neuter nominative singular) is the correct form; this affects only Claude's own chat-draft labels going forward, not the HTML itself, whose UI string is the compound "मूलगीताश्लोकः" (already grammatically fine as a compound stem, no change needed there).*

*Next session: continue Chapter XI at 11.46 — its मूल opens "किरीटिनं गदिनं चक्रहस्तमिच्छामि त्वां द्रष्टुमहं तथैव..." (already visible in the OCR right after 11.45's रा commentary, and on PDF page 414 bottom, already rendered this session), continuing अर्जुन उवाच (confirmed via direct PDF read this session that no speaker change occurs at 11.46 — Kṛṣṇa doesn't resume speaking until 11.47, श्रीभगवानुवाच, visible on the same page right after 11.46 closes). Re-verify against the PDF at draft time, draft रा-only, and proceed only on explicit approval. Remember: **transcribe 〔रा॑ only, never 〔वि॑** (see "Key source note" — this was briefly violated at 11.41–11.45, see (23)-(24) above, do not repeat); bold only an exact word-form match to the मूल — never a vigraha re-inflection, even one reusing the compound's own roots (see (9) above), except when राॕ is showing अन्वयः between two genuinely separate मूल words, in which case both are bolded (see (24)(c) above, a new pattern distinct from vigraha); footnote numbering resets per page, and can even repeat a digit within one verse's own footnote set if that verse's content spans two pages (see (12)/(13) in the Resume Pointer, and (19) above) — always trace by position, never by digit; watch for व/ब, (ग)/(रा), and उत्त/उक्त-type single-akṣara OCR confusions (see (13), (16), and (24)(d) above); not every verse necessarily has a 〔वि॑ commentary in the print — confirmed absent (not missing) at 11.44, see Resume Pointer (17); never assume a (वि)/(रा) block's scope ends at a page-image boundary — always render the following page and check for a heading change (see (18) above); **look closely for footnote superscripts that can hide among real quotation marks in राॕ's own commentary text — and when zooming still can't resolve a mark to a confirmed digit, flag it rather than force it either way (see (19) and (21) above)**; re-fetch and verify any file write against the actual machine before reporting it done (see (17) [history] above). Single reference file going forward.*
