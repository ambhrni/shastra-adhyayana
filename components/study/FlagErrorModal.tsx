...
interface FlagErrorModalProps {
  passageId: string
  commentators: Commentator[]
  onClose: () => void
}

export default function FlagErrorModal({ passageId, commentators, onClose }: FlagErrorModalProps) {
  const [commentatorId, setCommentatorId] = useState<string>('')
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    await fetch('/api/flags', {
      ...
      body: JSON.stringify({
        ...
        commentator_id: commentatorId || null,
        description_of_error: description,
      }),
    })
    setSubmitted(true)
    setSubmitting(false)
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-6">
        <div className="flex items-center justify-between mb-4">
          <h2 className="font-semibold text-stone-900">Flag an error</h2>
        ...
        {submitted ? (
          <div className="text-center py-6 text-emerald-600">
            ...
            <p className="text-sm font-medium">Flag submitted — thank you!</p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <select
                value={commentatorId}
                onChange={e => setCommentatorId(e.target.value)}
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                placeholder="e.g. 'तत्त्व' appears as 'तत्व' in line 3"
